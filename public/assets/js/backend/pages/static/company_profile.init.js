...
$('.dropify').dropify({
    messages: {
        'default': 'Drag and drop a file here or click. ( File should be .pdf format and file size should not be more then 10 MB)',
    ...
    error: {
        ...
        'fileFormat': 'The file format is not allowed (pdf).'        
    }
});
// adding functions
