...
$(document).ready(function(){
    $('#edit-slide-form #submit').on('click', function(e){
        
        e.preventDefault();
            // Get form
            var form = $('#edit-slide-form')[0];

            // Create an FormData object 
            var data = new FormData(form);

            $("#edit-slide-form #submit span").addClass('spinner-grow');
            // disabled the submit button
            $("#edit-slide-form #submit").prop("disabled", true);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#edit-slide-form #submit span").removeClass('spinner-grow');
                    $("#edit-slide-form #submit").prop("disabled", false);
                },
                error: function (e) {
                    console.log("ERROR : ", e);
                }
