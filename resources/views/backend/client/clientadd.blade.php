...
@section('css')
    ...
    @endsection
@section('page-title', 'Adding Client')
@section('content')
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body p-5">
				<form class="form-horizontal" role="form" id="add-client-form" action="{{ route('add-post-client') }}">
					<div class="row">
						<div class="col-12 mr-auto">
							<div class="form-group row">
								<label for="name" class="col-sm-2 col-form-label">Name*</label>
								<div class="col-sm-4">
									<input type="text" data-parsley-group="general" required name="name" class="form-control"/>
								</div>
							</div>                    
							<div class="form-group row">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/client/clientadd.init.js') }}"></script>
@endsection