...
@section('title', 'Adding Project')
@section('meta')
    <meta content="Adding Project" name="description" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="project-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('add-post-project') }}" id="add-project-form">
                                ...
                                <div class="row">
                                    <div class="col-12 mr-auto">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="page_url" name="page_url" data-parsley-group="general" type="text" placeholder="" required class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="page_url_ar" class="col-sm-2 col-form-label">{{ __('admin.page_URL') }}(AR) *</label>
                                            <div class="col-sm-10">
                                                <input id="page_url_ar" name="page_url_ar" data-parsley-group="general" type="text" placeholder="" required class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea id="project-desc-en-editor" style="height: 400px;">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea id="project-desc-ar-editor" style="height: 400px;">
                                                </textarea> <!-- end Snow-editor-->
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mr-auto">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="img_alt" type="text" data-parsley-group="general" name="img_alt" placeholder="" data-parsley-group="image" class="form-control">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                    <div class="col-12 mr-auto">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="img_alt_ar" data-parsley-group="image" type="text" name="img_alt_ar" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card-box">
                                            ...
                                            <input type="file" data-parsley-group="image" name="image_1" data-default-file="" data-allowed-file-extensions="jpg png gif" class="dropify" data-max-file-size="2M" {{-- data-min-width="800" data-min-height="608" --}}/>
                                        </div>
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-box">
                                            ...
                                            <input type="file" name="image_2" class="dropify" data-allowed-file-extensions="jpg png gif" data-max-file-size="2M" {{-- data-min-width="800" data-min-height="608" --}}/>
                                        </div>
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-box">
                                            ...
                                            <input type="file" name="image_3" class="dropify" data-allowed-file-extensions="jpg png gif" data-max-file-size="2M" {{-- data-min-width="800" data-min-height="608" --}}/>
                                        </div>
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-box">
                                            ...
                                            <input type="file" name="image_4" class="dropify" data-allowed-file-extensions="jpg png gif" data-max-file-size="2M" {{-- data-min-width="800" data-min-height="608" --}}/>
                                        </div>
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="card-box">
                                            ...
                                            <input type="file" name="image_5" class="dropify" data-allowed-file-extensions="jpg png gif" data-max-file-size="2M" {{-- data-min-width="800" data-min-height="608" --}}/>
                                        </div>
                                    </div><!-- end col -->
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mr-auto">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="meta-title" type="text" name="meta_title" placeholder=""  class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="meta_desc" class="form-control" name="meta_desc" placeholder=""/>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div>
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/project/projectadd.init.js') }}"></script>
    <script>
