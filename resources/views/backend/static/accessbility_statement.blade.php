...
@section('title', 'Accessbility Statement Page')
@section('meta')
    <meta content="keywords" name="Accessbility Statement Page" />
    <meta content="description" name="Accessbility Statement Page" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
    <link href="{{ asset('assets/libs/toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
    @endsection
@section('page-title', 'Accessbility Statement Page')
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-accessbility-statement') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/accessbility_statement.init.js') }}"></script>
    <script>
