...
@section('title', 'Word From Director Page')
@section('meta')
    <meta content="keywords" name="Word From Director" />
    <meta content="description" name="Word From Director" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
    <link href="{{ asset('assets/libs/toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
    @endsection
@section('page-title', 'Word From Director')
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-word-from-director') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/word_from_director.init.js') }}"></script>
    <script>
