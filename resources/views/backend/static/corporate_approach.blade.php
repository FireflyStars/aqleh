...
@section('title', 'Corporate Approach Page')
@section('meta')
    <meta content="keywords" name="Corporate Approach Page" />
    <meta content="description" name="Corporate Approach Page" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
    <link href="{{ asset('assets/libs/toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
    @endsection
@section('page-title', 'Corporate Approach Page')
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-corporate-approach') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/corporate_approach.init.js') }}"></script>
    <script>
