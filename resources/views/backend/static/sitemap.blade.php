...
@section('meta')
    <meta content="keywords" name="SiteMap Page" />
    <meta content="description" name="SiteMap Page" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
    <link href="{{ asset('assets/libs/toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
    @endsection
@section('page-title', 'SiteMap Page')
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-sitemap') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/sitemap.init.js') }}"></script>
    <script>
