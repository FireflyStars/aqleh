...
@section('title', 'Cookie Policy Page')
@section('meta')
    <meta content="keywords" name="Cookie Policy Page" />
    <meta content="description" name="Cookie Policy Page" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
    <link href="{{ asset('assets/libs/toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
    @endsection
@section('page-title', 'Cookie Policy Page')
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-cookie-policy') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/cookie_policy.init.js') }}"></script>
    <script>
