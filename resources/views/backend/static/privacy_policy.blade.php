...
@section('meta')
    <meta content="keywords" name="Privacy Policy Page" />
    <meta content="description" name="Privacy Policy Page" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
    <link href="{{ asset('assets/libs/toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
    @endsection
@section('page-title', 'Privacy Policy Page')
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-privacy-policy') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/privacy_policy.init.js') }}"></script>
    <script>
