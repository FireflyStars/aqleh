...
@section('title', 'Company Capability')
@section('meta')
    <meta content="keywords" name="Company Capability Page" />
    <meta content="description" name="Company Capability Page" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
    <link href="{{ asset('assets/libs/toastr/toastr.min.css') }}" rel="stylesheet" type="text/css" />
    @endsection
@section('page-title', 'Company Capability Page')
@section('content')
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-company-capability') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/company_capability.init.js') }}"></script>
    <script>
	window.onload = function() {
		CKEDITOR.replace( 'static-desc-en-editor', {
            extraPlugins: 'uploadimage, tableresize',
			filebrowserUploadUrl: '{{ route("upload-company-capability", ["_token" => csrf_token() ])}}',
