...
@section('title', 'Meet Our Team Page')
@section('meta')
    <meta content="keywords" name="Meet Our Team" />
    <meta content="description" name="Meet Our Team" />
@endsection
@section('css')
    {{-- <!-- Plugins css --> --}}
        ...
        <div class="card">
            <div class="card-body p-0">
                <div id="static-panel">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('update-meet-our-team') }}" id="edit-static-form">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/backend/pages/static/meet_our_team.init.js') }}"></script>
    <script>
