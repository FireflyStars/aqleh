...
@section('title', 'Aqleh Engineering Consultant')
@section('meta')
	<meta name="description" content="Aqleh Engineering Consultant">
	<meta name="keywords" content="Aqleh Engineering Consultant">
@endsection
...
{{-- Banner Start --}}
	...
	<section class="page-banner" id="projects-banner" style="background:url({{ session()->get('banner_url') }}) center center/cover no-repeat local">
		<div class="container">
			<div class="title-box">
				<h1 class="text-capitalize">{{ __('message.projects') }}</h1>
				<ol class="breadcrumb m-0 p-0 justify-content-center">
					<li><a href="{{ route('home') }}">{{ __('message.home') }}</a></li>
					<li>{{ __('message.projects') }}</li>
				</ol>
			</div>
		</div>
	</section>
...
{{-- Project Section Start --}}
	<section class="projects pt-5" style="position:relative">
		<div class="container">
			<div class="row">
				@foreach ($projects as $key => $item)
					<div class="col-lg-4 col-sm-6">
						<div class="project-box text-center mb-3">
...
@endsection
@section('js')
<script src="{{ asset('assets/js/frontend/pages/project/projects.init.js') }}"></script>
@endsection